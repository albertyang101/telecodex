...
- Agent Skill checkpoint: ALB-716 comment `bf17c7f9-a1d7-4d31-85f9-53c339f47736`; CC repo has a draft at `templates/global-skills/build-codex-dispatcher-bot/SKILL.md`, currently untracked, read-only inspected but not modified to avoid the parallel CC Dispatcher WIP.
...
- Finish bot polish gaps beyond current name/username proof: description, commands, avatar, and persona/runtime setting audit.
